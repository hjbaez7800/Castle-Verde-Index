...
const supabaseUrl = "https://qzhvszlpmwaroqitwuzq.supabase.co"; // <-- Replace with your Project URL
const supabaseAnonKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InF6aHZzemxwbXdhcm9xaXR3dXpxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUyODIyNzgsImV4cCI6MjA2MDg1ODI3OH0.OoBurZr4sWhdQ8VuUWEifqZDoHvD4l-iZKOcjaLGqYA"; // <-- Replace with your 'anon public' key
